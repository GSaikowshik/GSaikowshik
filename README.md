...
| :--- | :--- | :--- | :--- |
| **💡 DayZero AI** | A startup idea validation platform featuring AI-driven market analysis to help founders pivot quickly. | React, FastAPI, Supabase | [Live Demo](https://dayzeroai.vercel.app/) |
| **♻️ Waste Vision** | An AI system for waste classification using YOLOv8 and Deep Learning for real-time inference. | Python, YOLOv8, Streamlit | [Live Demo](https://waste-vision.streamlit.app/) |
| **📄 INSTA REPO** | An AI-powered builder for instant resumes and portfolios. | Python, Streamlit, Gemini API | [Live Demo](https://insta-repo.streamlit.app/) |
